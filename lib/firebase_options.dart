// Temporary Firebase options stub. Replace with real generated file by running:
// flutterfire configure
// These values are placeholders to satisfy compilation and MUST be updated.
...
class DefaultFirebaseOptions {
  static FirebaseOptions get currentPlatform {
    if (kIsWeb) {
      return web; // adjust when real config available
    }
